    ...
    'nodeInfos': [
      {
        ...
        'image': 'https://grafana.freifunk-rhein-sieg.net/render/d-solo/000000026/node?panelId=1&var-node={NODE_ID}&from=now-1d&width=650&height=350&theme=light&_t={TIME}',
        'title': 'Clientstatistik für {NODE_ID} - weiteren Statistiken'
      },
      {
        'name': 'Trafficstatistik',
        'href': 'https://map.freifunk-rhein-sieg.net/netz/statistik/node/{NODE_ID}/',
        'image': 'https://grafana.freifunk-rhein-sieg.net/render/d-solo/000000026/node?panelId=2&from=now-1d&var-node={NODE_ID}&width=650&height=350&theme=light&_t={TIME}',
        'title': 'Trafficstatistik für {NODE_ID} - weiteren Statistiken'
      },
      {
        'name': 'Systemlast',
        'href': 'https://map.freifunk-rhein-sieg.net/netz/statistik/node/{NODE_ID}/',
        'image': 'https://grafana.freifunk-rhein-sieg.net/render/d-solo/000000026/node?panelId=4&from=now-1d&var-node={NODE_ID}&width=650&height=350&theme=light&_t={TIME}',
    ...
    'linkInfos': [
      {
        ...
        'image': 'https://grafana.freifunk-rhein-sieg.net/render/d-solo/nvSNqoHmz/link?panelId=7&var-node={SOURCE_ID}&var-nodetolink={TARGET_ID}&from=now-1d&&width=650&height=350&theme=light&_t={TIME}',
    ...
    'globalInfos': [
      {
        ...
        'image': 'https://grafana.freifunk-rhein-sieg.net/render/d-solo/000000028/globals?panelId=2&from=now-7d&&width=650&height=350&theme=light&_t={TIME}',
